...
class HabitModel extends HabitEntity {
  ...
  Map<String, dynamic> toJson() {
    // FIX: Hapus 'id' dan 'created_at' dari map yang dikirim.
    // Database akan mengisi nilai default-nya secara otomatis saat INSERT.
    // Untuk UPDATE, 'id' digunakan di klausa .eq() bukan di dalam payload.
    return {
      'user_id': userId,
      'name': name,
...
// --- Habit Completion Model (Tidak perlu diubah) ---
